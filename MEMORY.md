...
- *[2026-05-24]* - Tony does not want Oboz emitting scholarship/college cron chatter or heartbeats. Those workflows should stay routed to Mega, and Oboz should only surface a message when there is a real result or blocker worth reporting.
