...
### System Health
- [ ] Prefer `openclaw-telegraf-metrics summary 80` for current VPS health.
- [ ] Use `openclaw-telegraf-metrics automation 80` for service/cron/log freshness checks.
...
### Automation Status
- [ ] Cron jobs running (check Telegraf `openclaw_automation_*` metrics first)
